...
if ($bg_color_type !== 'def') {
	$ico_id = uniqid( "cryptronick_ico_" );
	$ico_attr = 'id='.$ico_id;
}
...
$ico_wrap_classes .= !empty($item_el_class) ? ' '.$item_el_class : '';
...
?>
    ...
    <div <?php echo esc_attr($ico_attr); echo Cryptronick_Theme_Helper::render_html($ico_style_attr); ?> class="cryptronick_module_ico_progress<?php echo esc_attr($ico_wrap_classes) ?>">
