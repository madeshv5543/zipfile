...
if(!class_exists('Bpt_vc_addons')){
    class Bpt_vc_addons{
        static public $row_atts = array();

        public static function bpt_vc_row_before($atts, $content){
            $full_width = $output =  "";
            extract( $atts);         
            if($full_width == ''){
                $output .= '<div class="bpt-container">';
            }    
            return $output;     
        }
        
        public static function bpt_vc_row($atts, $content){         
            ...
            if ($full_width == 'stretch_row') {
                ...
                $css_classes = array('bpt_wrapper', vc_shortcode_custom_css_class( $css ));
            }
        ...
        public static function bpt_vc_row_after($atts, $content){         
            $output = $full_width = '';
            extract( $atts );
            if ($full_width == '') {
                $output .= '</div>';
...
if ( !function_exists( 'vc_theme_before_vc_row' ) ) {
    function vc_theme_before_vc_row($atts, $content = null) {
        return Bpt_vc_addons::bpt_vc_row_before($atts, $content);
    }
}
...
if ( !function_exists( 'vc_theme_vc_row' ) ) {
    function vc_theme_vc_row($atts, $content = null) {
        return Bpt_vc_addons::bpt_vc_row($atts, $content);
    }
}
...
if ( !function_exists( 'vc_theme_after_vc_row' ) ) {
    function vc_theme_after_vc_row($atts, $content = null) {
        return Bpt_vc_addons::bpt_vc_row_after($atts, $content);
    }
}